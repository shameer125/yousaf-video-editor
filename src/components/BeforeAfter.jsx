      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 lg:px-20 w-full">
        ...
        >
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            See the dramatic difference professional editing makes — from raw
            footage to polished, cinematic content.
          </p>
        </motion.div>
      ...
      <div className="px-5 pb-5">
        <div className="flex items-stretch gap-3">
          ...
          <div className="flex-1 relative rounded-xl overflow-hidden">
            <div
              className={`absolute inset-0 bg-gradient-to-br ${comparison.beforeColor}`}
            />
          ...
          <div className="flex-1 relative rounded-xl overflow-hidden">
            <div
              className={`absolute inset-0 bg-gradient-to-br ${comparison.afterColor}`}
            />
